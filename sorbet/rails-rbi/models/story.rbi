...
# Please rerun rake rails_rbi:models[Story] to regenerate.
...
class Story < ApplicationRecord
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(Story) }
...
class Story::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: Story).void).returns(T::Array[Story]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Story]) }
...
class Story::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Story::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
